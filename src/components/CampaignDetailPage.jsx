...
function CampaignDetailPage() {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.error(
        `Failed to delete campaign. ${err.message || "Please try again later."}`
      );
    }
  };
  ...
  const progressPercent = calculateProgress(
    typeof campaign.current_amount === "number"
      ? campaign.current_amount
      : parseFloat(campaign.current_amount) || 0,
    typeof campaign.funding_goal === "number"
      ? campaign.funding_goal
      : parseFloat(campaign.funding_goal) || 1
  );
    ...
    <div className=" bg-white container mx-auto px-4 pt-24 pb-12 max-w-7xl">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span>
                  {campaign.user.full_name} is organizing this fundraiser
                </span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Category: <strong>{campaign.category.name}</strong>
                </span>
              </div>
            </div>
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            <img
              src={
                ...
                "https://placehold.co/600x400/98a9d6/ffffff?text=No+Image"
              }
              alt="Campaign Image"
              loading="lazy"
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span>
                    <strong className="text-purple-600">
                      {campaign.total_donations} people
                    </strong>{" "}
                    have donated
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between text-sm text-gray-700">
                    ...
                    <span className="font-semibold text-gray-900">
                      {new Date(
                        estimationData.estimated_completion_date
                      ).toLocaleDateString()}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between text-sm text-gray-700">
                    ...
                    <span className="font-semibold text-gray-900">
                      {estimationData.days_remaining} days
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between text-sm text-gray-700">
                    ...
                    <span className="font-semibold text-gray-900">
                      Rs. {estimationData.average_daily_donation}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between text-sm text-gray-700">
                    ...
                    <span className="font-semibold text-gray-900">
                      Rs. {estimationData.remaining_amount}
                    </span>
                  </div>
                </div>
              </div>
      ...
      {user && (
        <ChatWidget
          ...
          recepient_id={
            campaign?.user?.id !== user?.id ? campaign?.user?.id : null
          }
        />
      )}
    </div>
